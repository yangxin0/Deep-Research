...
from .modules.outline_generation import MindMapOutlineGenerationModule
...
class STORMARLMConfigs(LMConfigs):
...
class STORMARRunner(Engine):
    
    def __init__(
        self, args: STORMARRunnerArguments, lm_configs: STORMARLMConfigs, rm, tools: list = []
    ):
        ...
        self.storm_outline_generation_module = MindMapOutlineGenerationModule(
